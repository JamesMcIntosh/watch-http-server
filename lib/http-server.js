...
var HTTPServer = exports.HTTPServer = function (options) {
  ...
  portfinder.getPort(function (err, port) {
    ...
    this.wss.broadcast = function broadcast(data) {
      // console.log('Broadcasting to ' + this.clients.size + ': ' + data);
    ...
    watcher.on('ready', function() { console.log('Scanned working directory (' + workingDirectory + '). ready for changes..'); watcher_ready = true; });
